...
Uses pyiqa for a robust no-reference NIQE implementation.
"""
...
def compute_niqe(image: ImageInput, device: str | None = None) -> float:
    return NIQEMetric(device=device).score(image)
