...
def _validate_inputs(image_bgr: np.ndarray, color_space: str) -> str:
...
def apply_global_histogram_equalization(
    ...
    color_space = _validate_inputs(image_bgr, color_space)
...
def process_image(
    ...
    processed = apply_global_histogram_equalization(
        image_bgr=image,
